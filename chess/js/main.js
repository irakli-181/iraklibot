...
var whiteSquareGrey = "rgba(71, 134, 151, 0.75)";
var blackSquareGrey = "rgba(71, 134, 151, 1)";
...
var weights = { p: 100, n: 225, b: 300, r: 500, q: 900, k: 60000, k_e: 60000 };
var pst_w = {
  p: [
    ...
    [-26, 3, 10, 9, 6, 1, 0, -23],
    [-22, 0, 10, 50, 50, 0, 0, -20],
    [-10, 50, 10, 40, 40, -20, 50, -10],
    [0, 0, 0, 0, 0, 0, 0, 0],
  ],
  n: [
    [-66, -53, -75, -75, -10, -55, -58, -70],
    [-3, -6, 40, -36, 4, 62, -4, -14],
    [10, 67, 1, 74, 73, 27, 60, -2],
    [0, 24, 45, 30, 30, 30, 25, 0],
    [-1, 5, 31, 21, 22, 35, 2, 0],
  ...
  b: [
    [-50, -70, -80, -70, -20, -107, -37, -50],
    [-11, 20, 35, -42, -39, 10, 2, -22],
    [-9, 30, -32, 41, 52, -10, 20, -14],
    [25, 17, 20, 34, 26, 25, 15, 10],
    [13, 10, 17, 23, 17, 16, 0, 7],
    [14, 25, 24, 15, 8, 25, 20, 15],
    [19, 35, 11, 6, 7, 6, 35, 16],
    [-7, 2, -15, -12, -14, -15, -10, -10],
  ],
  r: [
    [35, 29, 33, 40, 37, 33, 56, 50],
...
function updateAdvantage() {
  if (globalSum > 0) {
    $("#advantageColor").text("შავების");
    $("#advantageNumber").text(globalSum);
  } else if (globalSum < 0) {
    $("#advantageColor").text("თეთრების");
    $("#advantageNumber").text(-globalSum);
  } else {
    $("#advantageColor").text("თანაბარი");
    $("#advantageNumber").text(globalSum);
  }
  $("#advantageBar").attr({
    "aria-valuenow": `${-globalSum}`,
    style: `width: ${((globalSum + 10) / 20) * 100}%`,
  });
}
...
function makeBestMove(color) {
  ...
  globalSum = Math.round(evaluateBoard(game, move, globalSum, "b")) / 100;
  updateAdvantage();
...
$("#undoBtn").on("click", function () {
  if (game.history().length >= 2) {
    ...
    alert("ჯერ გეთამაშა რამდენიმე სვლა...");
  }
  $("#undotBtn").off("click");
  $("#undotBtn").unbind("click");
