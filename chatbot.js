...
function chatBot() {
  ...
  this.respondTo = function(input) {
      ...
      $.each(test, function(key, value) {
          ...
          $(".fuzzytext").prepend(
              '<div class="foreach" style="color:darkgreen">' + trimnums + '  ' + value[1] + '</div>');
      });
      ...
      if (this.match('კოდის წერა|კოდინგი'))
          return "არა, მძულს";
...
$(function() {
  ...
  var updateChat = function(party, text) {
      ...
      var line = $('<div><span class="party" id="party1"></span> <span class="text"></span></div>');
